# Prerequisites
To understand the content of the document it is necessary to know the architecture of the technology (in the document *'The two technologies and the tools'*) and the definitions of the following concepts (in the document *'Fundamental Definitions'*):
