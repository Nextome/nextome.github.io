...
- access the portal https://hub.nextome.com/dashboard by entering the credentials provided by Nextome
...
The token obtained in the accessToken field will be used to authenticate all other requests. To do this, you need to add the Authorization field formatted as follows in the header:
Bearer <here the token>. For example:
...
The API call specifications are avaible at the following link https://api.nextome.dev/swagger-ui/index.html#/
