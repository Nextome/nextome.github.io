...
# Nextome iOS SDK - Integration Guide
...
!!!note
    ...
    ```
2. Import the Sdk, into your ***AppDelegate***
 ```swift title="AppDelegate"
 import PhoenixSdk
...
3. Initialize the sdk into your ***AppDelegate*** after `didFinishLaunchingWithOptions`
 ```swift
...
!!!warning
    Chose configuration TYPE = debug/release
